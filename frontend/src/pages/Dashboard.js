...
>
  ...
  <div className="relative rounded-3xl p-6 sm:p-7 lg:p-8 overflow-hidden border backdrop-blur-xl shadow-2xl bg-white/70 dark:bg-[#0b1120]/80 border-gray-200 dark:border-gray-700">
    ...
    <div className="relative z-10 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-indigo-600 to-purple-600 text-white">
        ...
        <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
          ...
          <div className="flex items-start gap-3">
            ...
            <p>
              ...
              <span className="font-semibold text-gray-900 dark:text-white">
                {insights.topMarginProduct?.name || "N/A"}
              </span>{" "}

              generated highest profit

              <span className="font-medium">
                {" "}₹{insights.topMarginProduct?.profit?.toLocaleString() || 0}
              </span>
          ...
          <div className="flex items-start gap-3">
            ...
            <p>
              ...
              <span className="font-medium">
                {" "}₹{insights.projected7DayRevenue?.toLocaleString() || 0}
              </span>
          ...
          <div className="flex items-start gap-3">
            ...
            <Package
              size={18}
              className="text-cyan-500 mt-[2px]"
            />

            <p>

              {insights.deadStockCount || 0} dead stock items
          ...
          <div className="flex items-start gap-3">
            ...
            <p>
              ...
              {insights.stockoutRisks || 0} products at stockout risk
